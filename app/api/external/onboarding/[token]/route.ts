...
export async function POST(req: Request, { params }: { params: { token: string } }) {
    try {
        ...
        const {
            ...
            middleName, nameAsPerAadhar, nationality, religion, caste, alternatePhone,
            dateOfJoining, employmentType, labourCardNo,
        ...
        const updatedEmployee = await prisma.employee.update({
            ...
            data: {
                ...
                nameAsPerAadhar: nameAsPerAadhar || existing.nameAsPerAadhar,

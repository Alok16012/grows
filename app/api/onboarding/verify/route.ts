            ...
            case "SALARY":
                ...
                const upsertedSalary = await prisma.employeeSalary.upsert({
                    ...
                    create: {
                        ...
                        pfEmployer: parseFloat(salaryData.pfEmployer || 0),
                        pfEmployee: parseFloat(salaryData.pfEmployee || 0),
                        esiEmployer: parseFloat(salaryData.esiEmployer || 0),
                        esiEmployee: parseFloat(salaryData.esiEmployee || 0),
                        status: "APPROVED",

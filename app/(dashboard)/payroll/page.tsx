...
export default function PayrollPage() {
    ...
    const WORKFLOW = [
        { step: 1, label: "Upload Attendance",       href: "/attendance/upload", icon: Upload,          desc: "Import monthly attendance Excel" },
        { step: 2, label: "Process Payroll",          href: "/payroll/process",  icon: Play,            desc: "Calculate wages site-wise" },
        { step: 3, label: "Wage Sheet",               href: "/payroll/wagesheet",icon: FileSpreadsheet, desc: "Download site wage sheets" },
        { step: 4, label: "Compliance Reports",       href: "/payroll/compliance",icon: ShieldCheck,    desc: "PF, ESI, PT challans" },
        { step: 5, label: "Salary Slips",             href: "/payroll/salary-slips", icon: IndianRupee, desc: "Generate & distribute slips" },
        { step: 6, label: "Lock Payroll",             href: "/payroll/final",    icon: Lock,            desc: "Finalize and lock the run" },
    ]

                                        ...
                                        <table style={{ width:"max-content", minWidth:"100%", borderCollapse:"collapse", fontSize:11 }}>
                                            <thead>
                                                <tr style={{ background:"var(--surface2)", borderBottom:"1px solid var(--border)" }}>
                                                    ...
                                                    <th colSpan={2} style={{...thSec,color:"#0D4A6B",background:"#CFE2F3"}}>EMPLOYER CONTRI</th>
                                                </tr>
                                                <tr style={{ background:"var(--surface2)", borderBottom:"2px solid var(--border)" }}>
                                                    ...
                                                    <th style={{...th,background:"#dbeafe"}}>CO CONTRI<br/>ESIC</th><th style={{...th,background:"#bfdbfe",color:"#1e40af"}}>CTC</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                {ldData ? (

...
ALTER TABLE "Payroll"
    ...
    ADD COLUMN IF NOT EXISTS "presentDays" DOUBLE PRECISION NOT NULL DEFAULT 26,
...
BEGIN
    ...
    ('presentDays', 'float8', 'DOUBLE PRECISION', 'NULLIF("presentDays"::text, '''')::double precision', true, '26'),
